...
covers:
  [
    'https://static.404wolf.com/example_nanotube.webp',
    'https://static.404wolf.com/first_top_view.webp',
  ]
description: |
  NATuG (Nucleic Acid Tube Grapher) was an academic research project I undertook
...
links: [["Github", "https://github.com/NATuG3/NATuG3"]]
---
...
<video
  src="https://static.404wolf.com/programOverview_0001_0001_0001.webm"
...
A technical briefing made in preparation for a "technical deep dive"
presentation on the project can be found
**[here](https://github.com/404Wolf/stainless-technical-breifing-natug/releases/download/v1.0/natug_technical_brief.pdf)**.

## Involvement

It was early 2022, in my professor's Physics class, when in my first homework
...
I love how code lets you make theory more tangible. By implementing known
algorithms computationally, processes become simpler and more practical. In some
cases, they become simply _possible_ and, critically, accessible. This project
was to involve me developing an application around a complex framework for
designing DNA nanotubes, which I could see would enable never before possible
designs, but also could serve as a tool for people with limited knowledge of the
field in general to learn more too. The project builds off my professor's
[research paper discussing DNA nanotube
design](https://www.sciencedirect.com/science/article/pii/S0006349506726303) by
implementing the theory in practical and user friendly software.

But before discussing the specific application I developed, it is important to
gain a brief understanding of the field surrounding the software.

## Background

I like to think of DNA nanotubes as a niche in the complex and ever-growing
...
There are many different forms of nanotubes that can be created, but they are
...
Making matters more complex is the fact that to actually go about transferring
...
While the process needed for nanotube design has been known for a while, up
...
however, there exists various tools for nontubular DNA nanostructure design.

# The program

![Side view plot](https://static.404wolf.com/side_view_plot.webp)

NATuG is, most simply put, a Python-based desktop application that is designed
...
easily traverse the nanotube design process with ease.

It's a very complex tool that I've continued to build on extensively, and
includes rendering features, a custom file format to bundle and save program
states, and much more. I've

![NATuG 2.0](https://static.404wolf.com/NATuG2.webp)

This is the third iteration of NATuG software, and is a complete overhaul both
...
When starting work on NATuG, I needed to start off choosing my UI and plotting
...
choose from. Ultimately, I settled on [QT's](https://www.qt.io/) UI framework,
...
[matplotlib](https://matplotlib.org/) as their, I elected to use
[pyqtgraph](https://www.pyqtgraph.org/) because of how well it integrates with
PyQt, and support for much needed interactivity. It's able to track clicks on
individual points, and update in real time.

## Adding features

![NATuG's first plot](https://static.404wolf.com/first_top_view.webp)

My first step with the program, before building a complex, multi-widget UI, was
...
and I'd have a lot I'd need to learn.

## The plots

![Side view plot](https://static.404wolf.com/topView_0002.svg)

NATuG consists of two plots: the **top view plot** and the **side view plot**.
Both plots display the same nanostructures, but from two different perspectives.
...
The top view plot displays a view of the nanotube from the top down, showcasing
...
that has information on the nucleosides in that region.

### Side View Plot

![Creating cross-strand exchanges](https://static.404wolf.com/creating_junctions.webp)

The side view provides a view as if the nanotube had been unrolled flat, and is
...
In the future, there's many other types of plot improvements, and even entirely
...
given perspective at once.

### The interface

![Multi-panel UI beginnings](https://static.404wolf.com/beginnings_of_ui.webp)

The primary goal of NATuG has been to make the nanotube design experience as
...
always having access to the configuration.

### Junctions!

![Possible junction types](https://static.404wolf.com/junction_types.webp)

One of the most important features of NATuG is the ability to create
...
[Moravec's Paradox](https://en.wikipedia.org/wiki/Moravec%27s_paradox), which is
...
[here](https://gist.github.com/404Wolf/bbbe24af9939124a0752b8909097e578).

# Takeaways

Firstly, there are many project-related takeaways worth discussing. Ultimately,
...
As I complete the initial version of the program, Professor Sherman and I are
...
program tackles conjoining strands, and the like.

[Nadrian Seeman](nadrianSeeman_0001)

Towards the end of the project we've also informally shared the project at NYU's
...
On a more personal note, this project was one of my best coding experiences yet.
...
it's not a means to an end, but is an end that provides more means.

## Learn more

![Poster preview](https://static.404wolf.com/natugPosterLowRes_0001.png)

Though this post attempts to discuss the needed background to understand what
NATuG does, I still strongly suggest reading my professor's
[paper on the design of DNA nanotubes](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1471877/).
...
[this poster I created showcasing the project](https://drive.google.com/file/d/1R7wqzkVm2bnDmgzsexkkqsYj_X0iEB5T/view?usp=sharing).

If you're interested in learning more about how to actually set up and use the
program, check out its
[user manual](https://github.com/NATuG3/Manual/blob/main/manual.pdf) and
[Github repository](https://github.com/NATuG3/NATuG3). Also, feel free to reach
