...
Here's a live demo of the VT CLI (in a [Cloudflare
container](https://developers.cloudflare.com/containers/)). This is *probably* a
bad idea, so please don't abuse it 😂.

<iframe
  src={`https://vt-demo-2.wolf-mermelstein.workers.dev/?id=${crypto.randomUUID()}`}
