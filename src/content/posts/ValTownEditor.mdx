---
title: Fullstack Language Servers
description:
...
date: '2025-01-01'
covers:
  - 'https://filedumpthing.val.run/blob/blob_file_1759703617005_00063d8e-b192-4ef1-be0f-46cfbdc902c0.png'
tags:
  - featured
  - work
---
...
[https://blog.val.town/vt-cli](https://blog.val.town/vt-cli)**

# Try it out!

Here's a live demo of Val Town's new open source "fullstack" LSP implementation,
running on a Cloudflare container, on a simple vite/Cloudflare worker frontend,
with our react/codemirror ls library. To use it, press the "connect" button, and
then start editing the code!

<iframe
  src={`https://cf-vtlsp-demo.val-town.workers.dev/?id=${crypto.randomUUID()}`}
  className="border border-solid border-black w-full h-[600px] rounded bg-slate-100 mb-4"
  title="Val Town LSP Demo"
></iframe>

(or watch a short demo here:)
...
[Mahmud Ridwan's great writeup of connecting CodeMirror & an LSP](https://hjr265.me/blog/codemirror-lsp/#language-server-over-websocket),
...
<video
  src="https://github.com/user-attachments/assets/5abbc5a3-b397-40fb-beed-f9595021f7a3"
