...
<div className="mr-4 w-[40%] float-left">
  ![The bottleneck](https://static.404wolf.com/bottleneck-15.png)
  <p className="text-sm mt-2">
      (Note that this is a bit simplified, since there are actually many nodejs
      servers behind haproxy, and requests are being consistent hashed to them)
  </p>
</div>
