...
And Bun also supports `node:cluster`! [(Deno does **not**)](https://docs.deno.com/api/node/cluster/).
...
If a deno process dies, then all the nodejs processes will see the socket file go
away and clean up their own memory state.
