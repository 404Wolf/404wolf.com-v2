...
type: 'blog'
date: '2026-06-26'
covers: ["https://i.imgur.com/wEs5p7w.png"]
description: |
...
tags: ['personal']
links: [["Github", "https://github.com/macro-inc/macro/tree/main/js/ai-editing-worker"]]
---
...
If you found this interesting, Macro is open source, so feel free to check out
the code
[here](https://github.com/macro-inc/macro/tree/main/js/ai-editing-worker)!
