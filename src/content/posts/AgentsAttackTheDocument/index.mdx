...
manually "type out" (generatec) long strings of text. Eventually, these
snippets could be generated by yet more agents, and streamed into existence, to
reduce the time it takes to start seeing edits!
