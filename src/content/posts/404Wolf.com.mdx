...
title: '404Wolf.com'
description: |
  How I made my website, and an overview of all its unique features, including
...
type: 'project'
date: '2024-01-01'
covers: ['https://static.404wolf.com/postEditor_0001.png']
...
I initially was planning on working on various other ongoing projects, such as
...
I began working on this website during my second week of my batch at
[Recurse Center](https://recurse.com), an amazing open-ended programming retreat
...
templated HTML, but I hadn't done `javascript` before. I really enjoyed
Harvard's CS50 React Native course's video, where they speed-teach the language
(which is public and can be found
[here](https://www.youtube.com/watch?v=X52b-8y2Hf4)). I also read over the
[learnxinyminutes.com](https://learnxinyminutes.com) website to get a brief
...
it's object-orianted. Everything is a descendent of a primitive `object`, much
...
For the frontend I went with React; I liked the idea of a composable component
...
learning, but bad for longer term maintenance.
...
project. I considered using `express` or `django` to serve the site and
corresponding API, but a Recurse batch-mate introduced me to
[NextJS](https://nextjs.org/), which was very easy to scaffold and fun to work
with. It was also very easy (and free!) to get it hosted with
[Vercel](https://vercel.com/). NextJS is an interesting framework that blends
...
and I met someone who introduced me to [Prisma](https://www.prisma.io/) and
`Postgresql`. Postgres is a relational database system, an extension of SQL, and
...
add a bit of padding to the left of a `div`, you can simply add the class
...
One fun thing I came across when designing the homepage UX is
[Typewriter.js](https://safi.me.uk/typewriterjs/), a library for simulating
...
you do typewriter animations in a very nice modonic style.
...
too. All posts on the site are of a specific `type`, either `project` or `blog`.
By going to the pattern matched URL `https://404wolf.com/posts/<type>s`, you can
...
[react-markdown](https://github.com/remarkjs/react-markdown) to render the
markdown, with some custom overrides to handle images and codeblocks. I talk
about this more [in this blog I wrote](/posts/blog/imageBlocks), but I've also
...
`000n` to the end, like `filename_0004.png`. It's a bit clunky and requires
...
`json`. Writing these scripts was rather simple, since I'm iteratively doing a
