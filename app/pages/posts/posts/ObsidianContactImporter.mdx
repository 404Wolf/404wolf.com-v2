---
id: "obsidianContactImport"
type: "project"
date: "2024"
covers: "Post-20240806180300351.webp"
tags: ["404wolf/personal"]
...
![Markdown all the way down](Post-20240802183939700.webp)
...
![Omnisearch](Post-20240806170104437.webp)
...
![My options](Post-20240806171003276.webp)
...
![Google Contact export](Post-20240806171751994.webp)
...
![Export all contacts](Post-20240806172024892.webp)
![What?](Post-20240806172020774.webp)
![Where to?](Post-20240806172014834.webp)
...
![My options](Post-20240806173810683.webp)
...
![VCF library](Post-20240806174857068.webp)
...
![The template](Post-20240806180300351.webp)
...
![Blog post metadata in frontmatter](Post-20240806180922110.webp)
...
![Obsidain meta bind](Post-20240806181431211.webp)
...
There's a bunch of utility builder functions that are able to prefetch all your dependencies. A common one is `buildNpmPackage`, which is *de facto* standard for `nixpkgs` packages (packages on the official registry) that are in `ts/js`. I'm using `bun` though, not `npm` or `node`.
...
![Notes prefixed with @](Post-20240806234120398.webp)
...
![Example from github 1](Post-20240806233519583.webp)
![What it becomes](Post-20240806233455698.webp)

![Setting I added](Post-20240806233809359.webp)
...
![Inline admonitions](Post-20240802211800749.webp)
![Adding one](Post-20240802211839755.webp)
...
* That is tested with Apple contacts so far. I want to test to see if this works with Google/other flavors of contacts too.
