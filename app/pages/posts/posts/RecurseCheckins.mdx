...
* Browser Phone Stuff:
  ...
  * It works! Kinda. I can now stream an android the the browser with very low latency, it loads almost instantly, and it *usually* does not lag out over time. There's still a bunch of flags and settings I need to adjust though.
