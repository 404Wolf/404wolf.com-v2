...
type: "project"
date: "2022"
covers: "example_nanotube, first_top_view"
...
![Example DNA nanotube](example_nanotube.webp|float=right)
...
![Side view plot](side_view_plot.webp|float=none|width=100)
...
![Creating cross-strand exchanges](creating_junctions.webp|float=right)
...
![Possible junction types](junction_types.webp|float=none|width=100)
